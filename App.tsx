...
const LectureIllustration = () => (
  <div className="relative w-full max-w-2xl mx-auto p-4 animate-float transition-all duration-700">
    <svg viewBox="0 0 800 600" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-2xl overflow-visible w-full h-auto" preserveAspectRatio="xMidYMid meet">
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-white overflow-x-hidden overflow-y-auto lg:overflow-hidden">
      <div className="hidden lg:flex flex-1 relative bg-slate-50 items-center justify-center overflow-hidden border-r border-slate-100 p-12">
        ...
        <div className="relative z-10 text-center w-full max-w-2xl">
          <LectureIllustration />
          <div className="mt-12">
            <h1 className="text-5xl font-black text-slate-900 tracking-tighter uppercase opacity-90">A.R.C. Portal</h1>
            <p className="mt-4 text-slate-400 font-bold uppercase tracking-[0.3em] text-xs">Automated Reporting Central</p>
          </div>
        </div>
      </div>

      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 relative bg-[#6b46c1] min-h-screen lg:min-h-0">
        ...
        <div className="w-full max-w-lg relative z-10 py-8">
          <div className="lg:hidden mb-12 text-center bg-white/10 rounded-[2.5rem] p-6 backdrop-blur-md border border-white/20">
             <LectureIllustration />
          </div>

          <div className="pearl-glass p-10 md:p-14 rounded-[3rem] space-y-12 animate-in fade-in zoom-in duration-500 bg-white/95 shadow-2xl">
            <header className="text-center space-y-8">
              ...
              <div className="relative inline-flex items-center justify-center group">
                ...
                <div className="relative px-14 py-4 bg-white border border-violet-100 rounded-full flex items-center gap-3 shadow-sm">
                  <div className="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.4)]"></div>
                  <h2 className="text-[13px] font-black text-slate-800 tracking-[0.5em] uppercase">Identity Verification</h2>
                </div>
              </div>
            </header>
            ...
            <div className="space-y-10">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-1">
                  ...
                  />
                  {error && (
                    <div className="text-[11px] font-black text-rose-500 uppercase tracking-widest mt-3 px-1 flex items-center gap-2">
                ...
                <div className="pt-2">
                  <Button type="submit" loading={loading}>Begin Session</Button>
                </div>
              </form>
              ...
              <button 
                ...
                className="w-full py-5 px-8 rounded-2xl font-black uppercase tracking-widest text-[11px] transition-all duration-300 flex items-center justify-center gap-4 border-2 border-slate-100 bg-white text-slate-600 hover:border-[#6b46c1] hover:text-[#6b46c1] active:scale-95 group shadow-sm"
              >
                {socialLoading ? (
          ...
          <div className="mt-12 text-center">
            <p className="text-white/40 text-[10px] uppercase tracking-[0.8em] font-black select-none">A.R.C. Protocol // Cluster v4.2.0</p>
          </div>
        </div>
      </div>
    </div>
